	...
	public void mouseClicked(MouseEvent e) {
		if (e.getModifiers() == InputEvent.BUTTON3_MASK) {
			...
			undoAction
					.setEnabled(enabled
							&& editable
							&& (lastAction == Actions.CUT || lastAction == Actions.PASTE));
